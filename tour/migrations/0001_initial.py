    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tour_detail_ru', to='tour.Tour')),
            ],
        ),
        migrations.CreateModel(
            name='TourDetailEN',
            fields=[
                ...
                ('title', models.CharField(max_length=31)),
                ('text', models.TextField()),
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tour_detail_en', to='tour.Tour')),
            ],
        ),
        migrations.CreateModel(
            name='TourDetailAZ',
            fields=[
                ...
                ('title', models.CharField(max_length=31)),
                ('text', models.TextField()),
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tour_detail_az', to='tour.Tour')),
            ],
        ),
        migrations.AddField(
            model_name='tour',
